        ...
        <div class="card mx-2 mt-2 mb-2 ">
           <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h4 class="text-primary">Fournisseur</h4>
                    <a href="fournisseur/create.php" class="btn btn-success">Ajouter
                ...
                <div class="card mt-2">
                            ...
                            <table class="table table-striped table-hover table-border table-sm table-dark" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <img src="fournisseur/uploads/<?php echo $row['logo']; ?>" alt="fournisseur" width="30" heigth="30">
                                        </td>
                                        ...
                                        <td class="">
                                            <a href="fournisseur/view.php?id=<?php echo $row['id']; ?>" class="pl-2" title="Voir"><i class="fas fa-eye text-success"></i></a>
                                            <a href="fournisseur/edit.php?id=<?php echo $row['id']; ?>" class="pl-2" title="Modifier"><i class="fas fa-pencil-alt text-warning"></i></a>
                                            <a href="fournisseur/delete.php?id=<?php echo $row['id']; ?>" class="pl-2" title="Supprimer"><i class="fas fa-trash text-danger"></i></a>
                                        </td>
                                    <tr>    
                                    <?php
                                        }
                    ...
                    <div class="card-footer ">
                        <?php   
                            ...
                            $effectif = $stmt->fetch();
                        ?>   
                        Total des fournisseurs : <span class="badge badge-pill badge-secondary ml-1"> <?php echo $effectif[0]; ?> </span> 
                        <?php
                            Database::disconnect();
                        ?> 
                    </div>
