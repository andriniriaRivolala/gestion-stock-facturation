    ...
    <div class="container">
        <div class="card bg-dark border border-white mx-auto mt-5 ">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                <div class="col-md " >
                    <img src="uploads/<?php echo $row['image'] ?>"  class="rounded mx-auto d-block my-2" width="200" height="200">
                </div>
                <div class="col-md">
                    ...
                    <h5 class="form-control my-2"><i class="fab fa-expeditedssl fa-lg"></i>
                      <span class="text-dark"><?php echo ' ' . $row['password'] ?></span>
                    </h5>
                    ...
                    <h5 class="form-control my-2"><i class="fa fa-envelope"></i>
                      ...
                      <a class="btn btn-outline-danger d-block my-1" href="../utilisateur.php"><i class="fa fa-sign-out-alt"></i><span>Retour</span></a>
