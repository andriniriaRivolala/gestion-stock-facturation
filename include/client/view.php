        ...
        <div class="card bg-dark border border-white mx-auto mt-5">
                ...
                <div class="card-body">
                    <div class="text-center mb-2">
                        <h4 class="text-md text-capitalize text-success"><?php echo $row['nom'] ?> <?php echo $row['prenom'] ?></h4>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <h5 class="form-control my-2"><i class="fa fa-envelope"></i>
                              <span class="text-wite"><?php echo ' ' . $row['codepostal'] ?></span>
                            </h5>
                              <a class="btn btn-outline-danger d-block my-1" href="../client.php"><i class="fa fa-sign-out-alt"></i><span>Retour</span></a>
                        </div>
              </div>
                </div>
            </div> 
